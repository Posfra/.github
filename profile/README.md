...
<p align="center">
  <strong>A Payment Platform Built For The Creator Economy.</strong>
</p>
...
Check out the [documentation](https://docs.posfra.com) to get started with `posfra.js` in minutes.
